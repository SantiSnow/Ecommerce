	...
	<div class='row'>
		<div class='col-md-5'>
			...
			<div class='form-group'>
					...
					<br /><br />
					<a href='ListaCompletaProductos.jsp' title='Lista completa'>Lista de productos completa</a>
					<br /><br />
					<p>Aqui puede modificar productos de la base de datos del sistema, buscandolos por codigo, para modificar su precio.
					Si lo desea tambien puede eliminar un producto desde el formulario a su derecha.</p>
					<br /><br />
					
					<form method='get' action='modificaProductos.jsp'>
		...
		<div class='col-md-5'>
			...
			<div class='form-group'>
					<h4>Eliminar</h4>
					<br /><br />
					<p>Aqui puede eliminar productos de la base de datos del sistema, buscandolos por codigo. Recuerde que tras 
					eliminar un producto, solo podra volver a ingresarlo a la base de datos manualmente con los datos correctos,
					Asi que solamente elimine el producto si esta seguro.</p>
					<br /><br />			
					...
					<br /><br />
					<a href='InicioEmpleados.jsp' title='Inicio'>Inicio empleados</a>
       			<br />
       			<br />
			</div>
		</div>
