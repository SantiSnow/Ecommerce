...
<div class="container">
	<div class="row">
		<div class="col-md-9">
			...
			<br />
			<div class="form-group">
					<p>Se modifico con exito el articulo a la base de datos, puede comprobarlo en el gestor o revisando la lista completa. Estos es el codigo
					del articulo modificado:</p>
					<%
						String codigoArticulo = request.getParameter("codigoarticulo");
						String precioArticulo = request.getParameter("precio");
						
						String instruccionUpdate = "UPDATE PRODUCTOS SET PRECIO='" + precioArticulo + "' WHERE CODIGOARTICULO='" + codigoArticulo +"';";
						...
						Class.forName("com.mysql.jdbc.Driver");
							...
							try{
								...
								//lo actualizamos
								miStatement.executeUpdate(instruccionUpdate);
								
								out.println("<p>El codigo del producto es: "+codigoArticulo+"</p>");
								out.println("<br /><p>El precio del producto es: "+precioArticulo+"</p>");
							}
							catch(Exception e){
        			...
        			<br />
        			<br />
        			<p>Para eliminar productos, puede hacer click aqui: <a href="EliminarModificarProductos.jsp" title="Modificiar Productos">Modificar Productos</a></p>
        			<br />
