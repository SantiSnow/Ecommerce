...
String instruccionSql = "INSERT INTO EMPLEADOS (NOMBRE, EMAIL, SECCION, PASS, EDAD, CODIGOEMPLEADO) VALUES ('" + nombre + "', '"+ email +"', '"+ seccion +"', '"+ password +"', '"+ edad +"', '"+ codigoEmpleado +"');";
...
<div class="container">
	<div class="row">
		<div class="col-md-9">
			...
			<br />
			<div class="form-group">
					<p>Bienvenido al sistema de empleados, ya ha quedado registrado junto con los datos que acaba de ingresar. Con su correo
					electronico y su contraseña podra ingresar al sistema para acceder a la base de datos. Estos son sus datos:</p>
					<ul>
						<li><strong>Correo Electronico</strong></li><%= request.getParameter("email") %>
						<li><strong>Nombre</strong></li><%= request.getParameter("nombre") %>
						<li><strong>Edad</strong></li><%= request.getParameter("edad") %>
						<li><strong>Codigo Empleado</strong></li><%= request.getParameter("codigoEmpleado") %>
						<li><strong>Seccion</strong></li><%= request.getParameter("seccion") %>
					</ul>
        			<br />
        			<br />
        			<p>Para ingresar con su nuevo usuario, puede hacer click aqui: <a href="IngresoSistemaEmpleados.jsp" title="Ingresar">Ingresar</a></p>
			</div>
		</div>
	</div>
</div>
