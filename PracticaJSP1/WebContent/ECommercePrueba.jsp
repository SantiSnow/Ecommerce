      ...
      <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
        <div id="carousel1" class="carousel slide">
          ...
          <div class="carousel-inner">
            <div class="item active"> <img src="images/proyect-publi1.png" id="carru1" alt="thumb" style="margin: auto; width: 1000px;">
              
            </div>
            <div class="item"> <img  src="images/publi2.png" id="carru2" alt="thumb" style="margin: auto; width: 1000px;">
...
<div class="container">
  <div class="row text-center">
    <div class="col-sm-4 col-md-4 col-lg-4 col-xs-6">
      <div class="thumbnail"> <a href="PaginaProductos.jsp"> <img src="images/asusE402.jpg" alt="Thumbnail Image 1" class="img-responsive"> </a>
        <div class="caption">
          <h3>Laptop Asus Amd</h3>
          <p>Computadora portatil. Precio: $68500.</p>
          <p><a href="#" class="btn btn-primary" role="button">Agregar al carrito</a></p>
        </div>
      </div>
    </div>
    <div class="col-sm-4 col-md-4 col-lg-4 col-xs-6">
      <div class="thumbnail"> <a href="PaginaProductos.jsp"> <img src="images/laptop intel.png" alt="Thumbnail Image 1" class="img-responsive"> </a>
        <div class="caption">
          <h3>Laptop Dell Intel</h3>
          <p>Computadora portatil. Precio: $35500.</p>
          <p><a href="#" class="btn btn-primary" role="button">Agregar al carrito</a> </p>
        </div>
      </div>
    </div>
    <div class="col-sm-4 col-md-4 col-lg-4 col-xs-6">
      <div class="thumbnail"> <a href="PaginaProductos.jsp"> <img src="images/huaweip30.jpg" alt="Thumbnail Image 1" class="img-responsive"> </a>
        <div class="caption">
          <h3>Huawei P30</h3>
    ...
    <div class="col-sm-4 col-md-4 col-lg-4 col-xs-6 hidden-lg hidden-md hidden-sm">
      <div class="thumbnail"> <a href="PaginaProductos.jsp"> <img src="images/mi9t.jpg" alt="Thumbnail Image 1" class="img-responsive"> </a>
        <div class="caption">
          <h3>Xiaomi MI9T</h3>
          <p>Smartphone. Precio: $21500.</p>
          <p><a href="#" class="btn btn-primary" role="button">Agregar al carrito</a></p>
        </div>
      </div>
    </div>
  ...
  <div class="row text-center hidden-xs">
    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
      <div class="thumbnail"> <a href="PaginaProductos.jsp"> <img src="images/iphonerx.jpg" alt="Thumbnail Image 1" class="img-responsive"></a>
        <div class="caption">
          <h3>IPhone XR</h3>
          <p>Smartphone Apple. Precio:$70500</p>
          <p><a href="#" class="btn btn-primary" role="button">Agregar al carrito</a> </p>
        </div>
      </div>
    </div>
    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
      <div class="thumbnail"> <a href="PaginaProductos.jsp"> <img src="images/macbook pro.jpg" alt="Thumbnail Image 1" class="img-responsive"> </a>
        <div class="caption">
          <h3>Macbook Pro</h3>
          <p>Computadora Mac Portatil. Precio:$32900</p>
          <p><a href="#" class="btn btn-primary" role="button">Agregar al carrito</a> </p>
        </div>
      </div>
    </div>
    <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
      <div class="thumbnail"> <a href="PaginaProductos.jsp"> <img src="images/kingston3.jpg" alt="Thumbnail Image 1" class="img-responsive"> </a>
        <div class="caption">
          <h3>Pendrive Kingston 128</h3>
          <p>Pendrive 128gb. Precio:$1100</p>
          <p><a href="#" class="btn btn-primary" role="button">Agregar al carrito</a> </p>
        </div>
      </div>
    </div>
