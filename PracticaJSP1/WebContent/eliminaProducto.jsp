					...
					<%					
						...
						Class.forName("com.mysql.jdbc.Driver");
							...
							try{
								...
								//lo eliminamos
								int columnasModificadas = miStatement.executeUpdate(instruccionSqlelimina);
								
								if (columnasModificadas > 0){
									out.println("<p>Se elimino con exito el articulo de la base de datos, puede comprobarlo en el gestor o revisando la lista completa. Este es el codigo del producto:</p>");
									out.println("<br />");
									out.println("Codigo: " + codigoArticulo);
									out.println("<br />");
									out.println("<p>Recuerde que si desea volver a agregar este producto debera hacerlo manualmente, desde el siguiente link: </p>");
								}
								else{
									out.print("No se encontraron registros para borrar.");
								}
