...
<div class="container">
			...
			<div class="container">
				...
				String instruccionSql = "SELECT * FROM PRODUCTOS WHERE NOMBREARTICULO LIKE '%"+parametroBusqueda+"%';" ;
				//datos encapsulados del servidor mysql
				DatosConexion d1 = new DatosConexion();
				//cargar el controlador jdbc dinamicamente
