	...
	<div class='row'>
		<div class='col-md-9'>
			...
			<div class='form-group'>
					...
					<h4>Bienvenido al sistema de empleados, esta es la pagina principal.</h4>
					<br /><br />
					...
					<br /><br />
					<p>Aqui puede introducir productos a la base de datos del sistema, ingrese codigo, precio, nombre y seccion sin dejar 
					campos sin rellenar o no se realizara la consulta. Para que la base de datos se mantenga organizada se recomienda introducir 
					los productos en letras mayusculas, si no conoce los datos del producto, consulte a su supervisor.</p>
					<br /><a href='IngresoProductos.jsp' title='Ingreso Productos'>Ingresar Productos al sistema</a>
				
					<br /><br /><p>Para eliminar o modificar productos, haga click aqui:</p>
