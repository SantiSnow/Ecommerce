...
<hr>
<h2 class="text-center">Informacion y Contacto:</h2>
<hr>
<div class="container">
  <div class="row">
    <div class="col-lg-9 col-md-9">
      <div class="media-object-default">
        <div class="media">
          <div class="media-left"><img class="metodoContacto" src="images/iconos/gmail.png" alt="placeholder image"></div>
          <div class="media-body">
            <h4 class="media-heading">Via Email</h4>
				<p>Podes enviarnos un email para consultar precios, stock, dudas, horarios de atencion, metodos de pago, o cualquier
				otra consulta que quieras hacernos, y te responderemos en el transcurso del dia lo antes posible. Recorda que nuestro 
				horario de consulta dentro del cual respondemos, es el mismo horario de nuestro local: Lunes a Viernes de 9:00 a 20:00. </p>
				<p><a href="mailto:aguirresantiago81@gmail?Subject=Contacto%20Desde%20El%20Sitio%20Web%20Consulta">¡Envianos un mail!</a></p>
		  </div>
        </div>
        <div class="media">
          <div class="media-left"><img class="metodoContacto" src="images/iconos/whatsapp.png" alt="placeholder image"></div>
          <div class="media-body">
            <h4 class="media-heading">Llamanos</h4>
            	<p>Si lo deseas, podes llamarnos por telefono, o enviarnos un whatsapp al 11-2233-4455 en cualquier momento.  Recorda que nuestro 
				horario de consulta dentro del cual respondemos, es el mismo horario de nuestro local: Lunes a Viernes de 9:00 a 20:00.</p>
            
          </div>
        </div>
        <div class="media">
          <div class="media-left"><img class="metodoContacto" src="images/iconos/carro-de-la-compra.png" alt="placeholder image"></div>
          <div class="media-body">
            <h4 class="media-heading">Nuestros locales</h4>
            	<p>Si queres acercarte a uno de nuestros locales, nos encontramos en Ituzaingo, Av. Alvear 1122, entre las calles Las Heras y Soler.
            	Tambien nos encontramos en Castelar, a 4 cuadras de la estacion en la calle Arias 3344, entre las calles Avellaneda y Carlos Casares.
            	Nuestros horarios de atencion son de 9:00 a 20:00. Te esperamos!</p>
...
<div class="container">
	...
	<h3>Como llegar:</h3>
		<div class="col-12">
			<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d13126.089600108357!2d-58.56772536539535!3d-34.6667626845125!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x95bcc62cc3ef7083%3A0x8867107f425fade5!2sUniversidad%20Nacional%20de%20La%20Matanza!5e0!3m2!1ses!2sar!4v1584562218938!5m2!1ses!2sar" width="600" height="450" frameborder="0" style="border:0;" allowfullscreen="" aria-hidden="false" tabindex="0"></iframe>
		</div>
	</div>
</div>
