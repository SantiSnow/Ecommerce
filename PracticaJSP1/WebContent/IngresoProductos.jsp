...
<hr>
<h2 class="text-center">Sistema de empleados</h2>
<hr>
<div class='container'>
	<div class='row'>
		<div class='col-md-9'>
			...
			<br />
			<div class='form-group'>
					<h4>Bienvenido al sistema de empleados, seccion ingreso de productos</h4>
					<br /><br />
					<p>Si lo desea, puede ver la lista de productos completa aqui:</p>
					<br /><br />
					<a href='ListaCompletaProductos.jsp' title='Lista completa sin formato'>Lista de productos completa</a>
					<br /><br />
					<p>Aqui puede introducir productos a la base de datos del sistema, ingrese codigo, precio, nombre y seccion sin 
					dejar campos sin rellenar o no se realizara la consulta. Para que la base de datos se mantenga organizada se recomienda 
					introducir los productos en letras mayusculas, si no conoce los datos del producto, consulte a su supervisor.</p>
					<br /><br />
					
					<form method='get' action='AgregaProducto.jsp'>
						<br /><br/><label for='codigoarticulo'>Codigo Articulo</label>
						<input type='text' name='codigoarticulo' placeholder='Codigo AR' class='form-control' required/>
						
						<br /><label for='nombrearticulo'>Nombre Articulo</label>
						<input type='text' name='nombrearticulo' placeholder='Nombre' class='form-control' required/>
						
						<br /><label for='seccion'>Seccion</label>
					...
					<br /><br />
					<p>Para eliminar o modificar productos, haga click aqui:</p>
					<a href='EliminarModificarProductos.jsp' title='Eliminar o modificar'>Eliminar o modificar productos</a>
       				<br />
       				<br />
       				<p>Para volver, haga click aqui:</p>
					<br /><br />
					<a href='InicioEmpleados.jsp' title='Inicio Empleados'>Volver al inicio</a>
       			<br />
			</div>
		</div>
	</div>
