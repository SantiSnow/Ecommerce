	...
	<div class="row">
		<div class="col-md-9">
			...
			<ul class="nav navbar-nav hidden-sm">
		    	<li class="dropdown"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" aria-haspopup="true">Ordenar por: <span class="caret"></span></a>
		          <ul class="dropdown-menu">
		            <li><a href="ListaCompletaAlfabeticaAsc.jsp">Nombre A-Z</a></li>
					<li><a href="ListaCompletaAlfabeticaDesc.jsp">Nombre Z-A</a></li>
					<li><a href="ListaCompletaPrecioMen.jsp">Precio Menor a Mayor</a></li>
					<li><a href="ListaCompletaPrecioMay.jsp">Precio Mayor a Menor</a></li>
		          </ul>
		        </li>
	      	</ul>
	      	<br />
...
<%
String instruccionSql = "SELECT * FROM PRODUCTOS ORDER BY NOMBREARTICULO DESC;";
...
Class.forName("com.mysql.jdbc.Driver");
	...
	try{
		...
		while(miResultado.next()){
			...
			//obtenemos url stock y ref imagen
			String url = miResultado.getString("URL");
			String imagen = miResultado.getString("FOTO");
			int stock = miResultado.getInt("STOCK");
			
			out.println("<div class='col-md-4'>");
			out.println("<form>");
			out.println("<strong>Producto</strong>");
			out.println("<br />");
			out.println("<img src='images/" + imagen + "' alt='" + imagen + "' class='img-responsive' id='imgBusq'>");
			out.println("<br />");
			out.println("Codigo Articulo: "+miResultado.getString("CODIGOARTICULO") + " <br /> " + miResultado.getString("NOMBREARTICULO") + " <br />Seccion: " + miResultado.getString("SECCION") + " <br /> Precio: $ " + miResultado.getString("PRECIO"));
			if(stock >= 0){
				out.println("<p>Hay stock del producto. Unidades: " + stock + "</p>");
			}
			else{
				out.println("<p>No hay stock del producto</p>");
			}
			out.println("<a href='" + url + "' class='btn btn-primary' role='button'>Comprar</a><br /><br />");
			out.println("<br />");
			out.println("</form>");
			out.println("</div>");
